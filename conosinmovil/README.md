...
| Sección | Contenido |
|---|---|
| Hero | Película que se controla con el scroll: al bajar, la pantalla rota se repara; al subir, vuelve atrás. Tres mensajes: cambio de pantalla en 1 hora, pantallas originales, garantía de 3 meses + protector de regalo. |
| Cifras | +11 años de experiencia, +15k reparaciones, 1 h (iPhone), 3 meses de garantía. |
| Servicios | Móviles, ordenadores, tablets (cada uno con un clip que se anima con el scroll) y accesorios. |
...
- **Seedance 2.0** (modo *fast*, 720p): película del hero (12 s, del móvil roto al reparado usando las dos imágenes como fotograma inicial y final) y tres clips de 5 s para los servicios.
